...
"""
Ce fichier permet de définir la classe plateaux modélisant le plateau  du jeu Tic-Tac-Toe, les différents testes permettant 
de le manipuler (initialisation et affichage des différentes mises à jours, choix de prochaine case, validation de la case, )
"""
